...
const WeatherWidget = () => {
  const [data, setData] = useState(null);  // Αποθηκεύουμε τα δεδομένα από το API
  const [loading, setLoading] = useState(true);  // Ελέγχουμε αν φορτώνει τα δεδομένα
  const [error, setError] = useState(null);  // Για τυχόν λάθη στο API call
